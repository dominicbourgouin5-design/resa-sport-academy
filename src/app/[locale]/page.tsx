  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-resa-navy text-white">
        ...
        {/* ─── Overlays — pensés pour la lisibilité du texte ─── */}
        {/* Dégradé latéral fort : opaque à gauche, transparent à droite */}
        <div
        ...
        {/* Voile vertical léger pour l'uniformité */}
      ...
      <section className="mx-auto max-w-7xl px-4 py-24 md:px-6">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {categories.map((c, i) => (
            <Reveal key={c.code} variant="up" delay={i * 120}>
